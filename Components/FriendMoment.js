...
export default function FriendMoment({ id, name, profile, type, time, location, screen }) {
    const navigation = useNavigation();

    return (
        <Pressable onPress={() => navigation.navigate(name + 'Moment', {name: name, profile: profile, time: time, location: location, type: type})}>
