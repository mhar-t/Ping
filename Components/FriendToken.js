...
export default function FriendToken({ id, name, profile, type, time, location, screen }) {
    const navigation = useNavigation();

    return (
        <Pressable onPress={() => navigation.navigate('DraftToken', {name: name, profile: profile, time: time, location: location})}>
